...
@section('title', 'Genesys Sync Report')
    ...
    <div id="kt_app_content_container" class="app-container">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack">
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                    <li class="breadcrumb-item text-muted">All Leads vs Genesys</li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card mb-5">
            <div class="card-body py-4">
                <form method="GET" action="{{ route('genesys-report.index') }}" class="d-flex align-items-end gap-4 flex-wrap">
                    <div>
                    ...
                    <div>
                        ...
                        <a href="{{ route('genesys-report.index') }}" class="btn btn-light ms-2">Reset</a>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="col-md-3">
                <div class="card card-flush h-100">
                    <div class="card-body d-flex flex-column justify-content-center text-center py-8">
                        ...
                        <span class="fs-6 text-gray-500 fw-semibold mt-1">Total Leads</span>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card card-flush h-100">
                    <div class="card-body d-flex flex-column justify-content-center text-center py-8">
                        ...
                        <span class="fs-6 text-gray-500 fw-semibold mt-1">Synced to Genesys</span>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
        ...
        <div class="card">
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="text-muted mt-1 fw-semibold fs-7">Leads not yet synced to Genesys</span>
                </h3>
            </div>
                        ...
                        <tbody>
                            @forelse($unsyncedLeads as $lead)
                                <tr>
                                    ...
                                    <td><span class="badge badge-light-info">{{ str_replace('_', ' ', $lead->type) }}</span></td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center text-muted py-6">All leads are synced to Genesys.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
