                                        ...
                                        <div class="col-lg-6 col-sm-4 col-md-4">
                                            ...
                                            <select class="form-select mb-2" name="city_id" id="city_id" required="required"
                                                ...
                                                @foreach ($cities as $city)
                                                    <option value="{{$city->id}}" @selected($branch->city_id == $city->id)>{{$city->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mt-5">
                                        <div class="mb-10 fv-row col-lg-6">
                                            ...
                                            <select class="form-select mb-2" name="status" required="required"
                                                ...
                                                data-allow-clear="true">
                                                <option value=""></option>
                                                <option value="1" @selected($branch->status==1)>True</option>
                                                <option value="0" @selected($branch->status==0)>False</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
