                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-4 col-sm-4 col-md-4">
                                                <label
                                                    class="required form-label">{{ __('After Login Dashboard Redirection') }}</label>
                                                <select class="form-select mb-2" name="page_redirect" id="page_redirect"
                                            ...
                                            <div class="col-lg-4 col-sm-4 col-md-4">
                                                ...
                                                <input type="number" class="form-control" placeholder="Enter no of months" value="{{$role->allowed_no_of_months}}" required name="allowed_no_of_months" id="allowed_no_of_months"
                                        ...
                                        <div class="fv-row">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                @include('admin.roles.permissions', [
                                                    'rolePermissionsArr' => $rolePermissions,
                                                ])
