                ...
                <div class="col-lg-4">
                            <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">{{ __('Vehicles List') }}</h1>
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('branch.index') }}" class="text-muted text-hover-primary">{{ __('Vehicle') }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    columns: [{
        ...
        },
        {
            ...
            render: function(data, type, row) {
                ...
                return `
                    <label><input type="checkbox" class="page_type_checkbox" data-id="${row.id}" data-target="vehicle" data-value="sales" ${checkedSales}> Sales</label>
                    <label><input type="checkbox" class="page_type_checkbox" data-id="${row.id}" data-target="vehicle" data-value="after_sales" ${checkedAfterSales}> After Sales</label>
                `;
            }
        },
