                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-4 col-md-4">
                                            ...
                                            <input type="text" name="national_id" id="national_id"  pattern="(\d{10}|0)" class="form-control mb-2"
                                                required />
                                        </div>
                                    ...
                                    <div class="row mt-5">
                                        ...
                                        <div class="mb-5 fv-row col-lg-6">
                                            <label class="required form-label">{{ __('Intention to Buy') }}</label>
                                            <select class="form-select mb-2" name="purchase_plan" id="purchase_plan" required="required"
                                                data-control="select2" data-placeholder="{{ __('select option') }}"
                                                data-allow-clear="true">
                                                    <option value=""></option>
                                        ...
                                        <div class="mb-5 fv-row col-lg-6">
                                            <label class="required form-label">{{ __('Monthly Salary') }}</label>
                                            <select class="form-select mb-2" name="monthly_salary" id="monthly_salary" required="required"
                                                data-control="select2" data-placeholder="{{ __('select option') }}"
                                                data-allow-clear="true">
                                                <option value=""></option>
                                                    <option value="Below 5,000">Below 5,000</option>
                                                    <option value="Between 5,000 and 7,000">Between 5,000 and 7,000</option>
                                                    <option value="Between 7,000 and 10,000">Between 7,000 and 10,000</option>
