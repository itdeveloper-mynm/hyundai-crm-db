                                        ...
                                        <div class="row mt-5">
                                            ...
                                            <div class="mb-5 fv-row col-lg-6">
                                                ...
                                                <select class="form-select mb-2" name="purchase_plan" id="purchase_plan"
                                                    ...
                                                    <option value="2-3 month" @selected($lead->purchase_plan == '2-3 month')>2-3 month
                                                    </option>
                                                    <option value="After 3 month" @selected($lead->purchase_plan == 'After 3 month')>After 3
                                                        month</option>
                                                </select>
                                            </div>
                                            <div class="mb-5 fv-row col-lg-6">
                                                ...
                                                <select class="form-select mb-2" name="monthly_salary"
                                                    ...
                                                    data-placeholder="{{ __('select option') }}" data-allow-clear="true">
                                                    <option value=""></option>
                                                    <option value="Between 5,000 and 10,000" @selected($lead->monthly_salary == 'Between 5,000 and 10,000')>
                                                        Between 5,000 and 10,000</option>
                                                    <option value="Above 10,000" @selected($lead->monthly_salary == 'Above 10,000')>Above 10,000
                                                    </option>
                                                    <option value="Cash Deal" @selected($lead->monthly_salary == 'Cash Deal')>Cash Deal
                                                    </option>
                                                </select>
                                            </div>
