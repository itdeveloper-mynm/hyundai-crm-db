                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-sm-4 col-md-4">
                                                ...
                                                <input type="text" name="first_name" id="first_name"
                                                    value="{{ $lead->customer->first_name }}" class="form-control mb-2"
                                                    required />
                                            </div>
                                            <div class="col-lg-6 col-sm-4 col-md-4">
                                                <label class="required form-label">{{ __('Last Name') }}</label>
                                                <input type="text" name="last_name" id="last_name"
                                                    value="{{ $lead->customer->last_name }}" class="form-control mb-2"
                                                    required />
                                            </div>

                                            <div class="col-lg-6 col-sm-4 col-md-4">
                                                <label class="required form-label">{{ __('Mobile') }}</label>
                                                <input type="text" disabled value="{{ $lead->customer->mobile }}"
                                                    class="form-control mb-2" required />
                                            </div>
                                            <div class="col-lg-6 col-sm-4 col-md-4">
                                                <label class="required form-label">{{ __('Email') }}</label>
                                                <input type="text" name="email" id="email"
                                                    value="{{ $lead->customer->email }}" class="form-control mb-2"
                                                    required />
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-sm-4 col-md-4">
                                                ...
                                                <input type="text" name="national_id" id="national_id"
                                                    value="{{ $lead->customer->national_id }}" pattern="(\d{10}|0)"
                                                    class="form-control mb-2" required />
                                            </div>
                                        ...
                                        <div class="row mt-5">
                                            <div class="mb-5 fv-row col-lg-6">
                                                ...
                                                <select class="form-select mb-2" name="city_id" id="city_id"
                                                    ...
                                                    @foreach ($cities as $city)
                                                        <option value="{{ $city->id }}" @selected($lead->city_id == $city->id)>
                                                            {{ $city->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="mb-5 fv-row col-lg-6">
                                                ...
                                                <select class="form-select mb-2" name="branch_id" id="branch_id"
                                                    ...
                                                    @foreach ($branches as $branch)
                                                        <option value="{{ $branch->id }}" @selected($lead->branch_id == $branch->id)>
                                                            {{ $branch->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="mb-5 fv-row col-lg-6">
                                                ...
                                                <select class="form-select mb-2" name="vehicle_id" required="required"
                                                    ...
                                                    @foreach ($vehicles as $vehicle)
                                                        <option value="{{ $vehicle->id }}" @selected($lead->vehicle_id == $vehicle->id)>
                                                            {{ $vehicle->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-lg-6 col-sm-4 col-md-4">
                                                ...
                                                <select class="form-select mb-2" name="yearr" id="yearr"
                                                    required="required" data-control="select2"
                                                    data-placeholder="{{ __('select option') }}" data-allow-clear="true">
                                                    <option value=""></option>
                                            ...
                                            <div class="mb-5 fv-row col-lg-6">
                                                ...
                                                <select class="form-select mb-2" name="purchase_plan" id="purchase_plan"
                                                    ...
                                                    <option value="2-3 months" @selected($lead->purchase_plan == '2-3 months')>2-3 months</option>
                                                    <option value="After 3 months" @selected($lead->purchase_plan == 'After 3 months')>After 3 months</option>
                                                </select>
                                            </div>
                                            <div class="mb-5 fv-row col-lg-6">
                                                <label class="form-label">{{ __('Monthly Salary') }}</label>
                                                <select class="form-select mb-2" name="monthly_salary"
                                                    id="monthly_salary" data-control="select2"
                                                    data-placeholder="{{ __('select option') }}" data-allow-clear="true">
                                                    <option value=""></option>
                                                    <option value="Below 5,000" @selected($lead->monthly_salary == 'Below 5,000')>Below 5,000</option>
                                                    <option value="Between 5,000 and 7,000" @selected($lead->monthly_salary == 'Between 5,000 and 7,000')>Between 5,000 and 7,000</option>
                                                    <option value="Between 7,000 and 10,000" @selected($lead->monthly_salary == 'Between 7,000 and 10,000')>Between 7,000 and 10,000</option>
                                            ...
                                            <div class="mb-5 fv-row col-lg-6">
                                                ...
                                                <select name="bank_id" id="bank_id" class="form-select mb-2"
                                                    ...
                                                    @foreach ($banks as $bank)
                                                        <option value="{{ $bank->id }}" @selected($lead->customer->bank_id == $bank->id)>
                                                            {{ $bank->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                                    ...
                                                    @foreach ($sources as $source)
                                                        @if (in_array($source->name, ['Email', 'Whatsapp', 'Inbound', 'Outbound']))
                                                            <option value="{{ $source->id }}"
                                                                @selected($lead->source_id == $source->id)>{{ $source->name }}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="mb-5 fv-row col-lg-6">
                                                <label
                                                    class="required form-label">{{ __('Preferred Time to contact') }}</label>
                                                <select class="form-select mb-2" name="preferred_appointment_time"
                                                    required="required" data-control="select2"
                                                    data-placeholder="{{ __('select option') }}" data-allow-clear="true">
                                                    <option value=""></option>
                                                    <option value="Morning (08:00AM~12:00PM)"
                                                        @selected($lead->preferred_appointment_time == 'Morning (08:00AM~12:00PM)')>Morning (08:00AM~12:00PM)</option>
                                                    <option value="Afternoon (12:00PM~04:00PM)"
                                                        @selected($lead->preferred_appointment_time == 'Afternoon (12:00PM~04:00PM)')>Afternoon (12:00PM~04:00PM)</option>
                                                    <option value="Any Time" @selected($lead->preferred_appointment_time == 'Any Time')>Any Time
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="mb-5 fv-row col-lg-6">
                                                ...
                                                <select class="form-select mb-2" name="category" id="category"
                                                    onchange="updateSubCategory()" required="required"
                                                    data-control="select2" data-placeholder="{{ __('select option') }}"
                                                    data-allow-clear="true"
                                                    @if ($lead->category == 'Qualified') disabled @endif>
                                                    <option value=""></option>
                                                    @foreach (getCategories() as $category)
                                                        <option value="{{ $category }}" @selected($lead->category == $category)>
                                                            {{ $category }}</option>
                                                    @endforeach
                                            ...
                                            <div class="mb-5 fv-row col-lg-6">
                                                ...
                                                <select class="form-select mb-2" name="sub_category" id="sub_category"
                                                    required="required" data-control="select2"
                                                    data-placeholder="{{ __('select option') }}" data-allow-clear="true"
                                                    @if ($lead->category == 'Qualified') disabled @endif>
                                                    <option value=""></option>
                                            ...
                                            <div class="mb-5 fv-row col-lg-6">
                                                ...
                                                <select class="form-select mb-2" name="kyc" id="kyc"
                                                    ...
                                                    data-placeholder="{{ __('select option') }}" data-allow-clear="true">
                                                    <option value=""></option>
                                                    <option value="Social Media" @selected($lead->kyc == 'Social Media')>Social Media
                                                    </option>
                                                    <option value="Friends & Relative">
                                                        @selected($lead->kyc == 'Friends & Relative')Friends & Relative</option>
                                                    <option value="Outdoor Advertisement" @selected($lead->kyc == 'Outdoor Advertisement')>
                                                        Outdoor Advertisement</option>
                                                    <option value="Influencer" @selected($lead->kyc == 'Influencer')>Influencer
                                                    </option>
        ...
        function updateSubCategory() {
            ...
            if (selectedCategory in categories) { // Changed from category to selectedCategory
                const optionsArray = categories[
                    selectedCategory]; // Changed from categories[category] to categories[selectedCategory]
