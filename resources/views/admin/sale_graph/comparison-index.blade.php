                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <select class="form-select mb-2"
                                                                    ...
                                                                    <option value="1 month"
                                                                        {{ is_selected('1 month', 'purchase_plan') }}>1 month</option>
                                                                    <option value="2-3 months"
                                                                        {{ is_selected('2-3 months', 'purchase_plan') }}>2-3 months</option>
                                                                    <option value="After 3 months"
                                                                        {{ is_selected('After 3 months', 'purchase_plan_comp') }}>After 3 months</option>
                                                                </select>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <select class="form-select mb-2"
                                                                    ...
                                                                    <option value="Below 5,000"
                                                                        {{ is_selected('Below 5,000', 'monthly_salary_comp') }}>Below 5,000</option>
                                                                    <option value="Between 5,000 and 7,000"
                                                                        {{ is_selected('Between 5,000 and 7,000', 'monthly_salary') }}>Between 5,000 and 7,000</option>
                                                                    <option value="Between 7,000 and 10,000"
                                                                        {{ is_selected('Between 7,000 and 10,000', 'monthly_salary') }}>Between 7,000 and 10,000</option>
                                                                    <option value="Above 10,000"
                                                                        {{ is_selected('Above 10,000', 'monthly_salary_comp') }}>Above 10,000</option>
                                                                    <option value="Cash Deal"
                                                                        {{ is_selected('Cash Deal', 'monthly_salary_comp') }}>Cash Deal</option>
                                                                </select>
                                                            </div>
        ...
        const data1_comp = {
            ...
            datasets: [{
                ...
                backgroundColor: (function() {
                    ...
                    return @json($salary_graph_comp['monthly_salary']).map(l => map[l] || 'rgb(201, 203, 207)');
                })(),
            }]
        };
        ...
        const data2_comp = {
            ...
            datasets: [{
                ...
                backgroundColor: (function() {
                    ...
                    return @json($purchase_plan_graph_comp['purchase_plan']).map(l => map[l] || 'rgb(201, 203, 207)');
                })(),
            }]
        };
