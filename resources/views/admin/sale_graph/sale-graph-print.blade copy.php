...
<body>
    ...
    <div class="container-fluid mt-4">
            ...
            <div class="col">
                ...
                <div class="kpi-card">
                    <div class="row text-center">
                        ...
                        <div class="col-md border-right">
                            <div class="kpi-title">CRM Conv (%)</div>
                        ...
                        <div class="col-md border-right">
                            <div class="kpi-title">Sale Conv (%)</div>
        ...
        <h5 style="font-weight: 600; color: #333;">MTD Performance</h5>
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 mt-4 mb-4 bank-section g-4 d-flex align-items-stretch">
            <div class="col d-flex">
                <div class="chart-wrapper p-3 w-100">
                    ...
                    <canvas id="graph_6" style="max-height: 250px;"></canvas>
                </div>
            </div>
            <div class="col d-flex">
                <div class="chart-wrapper p-3 w-100">
            ...
            <div class="col d-flex">
                <div class="chart-wrapper p-3 w-100">
                    ...
                    <canvas id="graph_7" style="max-height: 250px;"></canvas>
                </div>
            </div>
        </div>
            ...
            <div class="col d-flex">
                <div class="chart-wrapper p-3 w-100">
                    <h6
                        style="color: #2F469C; font-weight: 700; border-bottom: 1px dashed #6473AC; padding-bottom: 0.5rem;">
                        Monthly Salary</h6>
                    <canvas id="graph_10" style="max-height: 250px;"></canvas>
                </div>
            </div>
            ...
            <div class="col d-flex">
                <div class="chart-wrapper p-3 w-100">
                    <h6
                        style="color: #2F469C; font-weight: 700; border-bottom: 1px dashed #6473AC; padding-bottom: 0.5rem;">
                        Purchased Plan</h6>
                    <canvas id="graph_11" style="max-height: 250px;"></canvas>
                </div>
            </div>
        </div>
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 g-4 mb-10 bank-section">
      ...
      <div class="col mb-5">
        ...
        <h5 class="mt-3 bank-section" style="font-weight: 700; color: #2F469C;">Campaign Detial Overview</h5>
        ...
        @foreach ($allCampaignDetails as $index => $campaign)
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-1 g-4 bank-section">
                <!-- Campaign A -->
                <div class="col">
                    <div class="p-3"
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col metric-box">
                                ...
                                <div class="metric-value campaign">{{ $campaign['summary']['sale_conversion'] }}</div>
                            </div>
                        </div>
                    </div>
                </div>
