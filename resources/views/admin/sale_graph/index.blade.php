                ...
                <div class="card-toolbar ">
                    <div class="row  mt-5">
                        ...
                        <div class="col-lg-8 d-flex justify-content-end">
                            ...
                            {{-- <button id="printButton2" type="button" class="btn btn-success me-3" id="downloadPdfBtn"><a
                                    href="{{ route('sale-graph.print') }}">
                                    <span class="svg-icon svg-icon-2"> <i class="bi bi-file-earmark-spreadsheet"></i>
                                    </span>
                                    {{ __('Pdf') }}</a>
                            </button> --}}

                            <button type="button" class="btn btn-success me-3" id="downloadPdfBtn">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-500px" data-kt-menu="true"
                                ...
                                <form method="POST" action="#" class="form d-flex flex-column flex-lg-row"
                                    id="myForm">
                                    @csrf
                                    <div class="px-7 py-5">
                                        <div class="mb-3">
                                            @can('sale-graph-filters')
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <div>
                                                            <select class="form-select mb-2" name="agency" id="agency"
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-5">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-gray-400 mt-1 fw-semibold fs-6">Total Leads (<span
                                        id="total_performance_count">0</span>)</span>
                            </h3>
                            <!--end::Title-->
                        </div>
                        <!--end::Header-->
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-7 mb-7">
                            <!--begin::Title-->
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-800">Campaign Vehcile Performance
                                    Measurement</span>
                            </h3>
                            <!--end::Title-->
                        </div>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-7 mb-7">
                            <!--begin::Title-->
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-800">Campaign City Branches Performance
                                    Measurement</span>
                            </h3>
                            <!--end::Title-->
                        </div>
...
@section('js')
    ...
    --}}
        ...
        $(document).on('click', '.toggle-child-sources', function() {
            ...
            if (childName) {
                sourceRows = $('.' + childName + '[data-city-id="' + campaignId + '"][data-campaign-id="' +
                    campaignAttr + '"]');
            } else {
        ...
        function fetchAndRenderGraphData(formElement, mode = 'graph', callback = null) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (mode === 'graph') {
                        renderCustomLineChart(data.months, data.first_count, data.second_count, data
                            .third_count, data.fifth_count, data.second_graph_data);
                        renderVehicleAnalysisChart(data.vehicle_graph);
                        renderSalaryDoughnutChart(data.salary_graph.monthly_salary, data.salary_graph
                            .monthly_salary_count);
                        renderPurchasePlanPieChart(data.purchase_plan_graph.purchase_plan, data
                            .purchase_plan_graph.purchase_plan_count);
    ...
    <script>
        document.getElementById('downloadPdfBtn').addEventListener('click', function() {
            ...
            const url = new URL("{{ route('sale-graph.print') }}", window.location.origin);
            if (startDate) url.searchParams.append("start_date", startDate);
            if (endDate) url.searchParams.append("end_date", endDate);

            // Redirect to PDF route with query string
