...
<select class="form-select mb-2" name="monthly_salary[]" id="monthly_salary" data-control="select2"
    ...
    <option value="Between 5,000 and 7,000" {{ is_selected('Between 5,000 and 7,000', 'monthly_salary') }}>Between 5,000 and 7,000</option>
    <option value="Between 7,000 and 10,000" {{ is_selected('Between 7,000 and 10,000', 'monthly_salary') }}>Between 7,000 and 10,000</option>
