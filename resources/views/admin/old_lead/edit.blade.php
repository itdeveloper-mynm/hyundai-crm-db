                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="row mt-5">
                                        <div class="mb-5 fv-row col-lg-6">
                                            @include('admin.common_files.city' ,[ 'required' =>true, 'data' => $lead ])
                                        </div>
                                        <div class="mb-5 fv-row col-lg-6">
                                    ...
                                    <div class="row mt-5">
                                        ...
                                        <div class="col-lg-6 col-sm-4 col-md-4">
                                            ...
                                            <input type="date" name="select_date" id="select_date" value="{{formateDate($lead->created_at)}}" class="form-control mb-2"
                                                required />
                                        </div>
                                    </div>
...
$(document).ready(function() {
    ...
    $("#myForm").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('old-leads.update', [$lead->id]) }}",
                data: data,
                processData: false,
                contentType: false,
                cache: false,
