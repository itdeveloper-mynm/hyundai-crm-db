                ...
                <div class="card-toolbar ">
                    <div class="row  mt-5">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('lead.index') }}"
                                                class="text-muted text-hover-primary">{{ __('Targets') }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 d-flex justify-content-end">
                            ...
                            @endcan
                            @can('target-import')
                                <a href="{{ asset('excel_files/targets-sample.xlsx') }}" class="btn btn-warning  me-3" download>
                    ...
                    <table id="user_table" class="table table-striped table-bordered" width="100%">
                        <thead class="table-dark" style="border-radius: 10px 10px 10px 10px;">
                            <tr>
                                ...
                                <th class="min-w-100px">{{ __('Count') }}</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Import Targets</h3>
                    <!--begin::Close-->
