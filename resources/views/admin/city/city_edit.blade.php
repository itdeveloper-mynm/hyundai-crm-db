                                    ...
                                    <div class="row mt-5">
                                        <div class="mb-10 fv-row col-lg-6">
                                            ...
                                            <select class="form-select mb-2" name="status" required="required"
                                                ...
                                                <option value=""></option>
                                                <option value="1" @selected($city->status==1)>True</option>
                                                <option value="0" @selected($city->status==0)>False</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-5 fv-row col-lg-6">
                                            @include('admin.common_files.page_type_input', ['page_chk' => 'edit' , 'field_value'=> $city->page_type ])
                                        </div>
                                    </div>
