...
@section('title', 'Contact Us Report')
                                    ...
                                    <div class="px-7 py-5">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <a href="{{ route('contact-us-graph.index') }}"
...
@section('js')
    ...
    <script>
        ...
        const data = {
            labels: labels,
            datasets: [{
                    label: 'Contact Us ('+ @json($total_performance_count) +')',
