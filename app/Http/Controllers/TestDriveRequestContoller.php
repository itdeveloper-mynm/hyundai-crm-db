...
class TestDriveRequestContoller extends Controller
{
    ...
    public function testDrivePagination()
    {
        ...
        $paginate =  Application::search($conditions)
                ->where('type','request_a_test_drive')
   ...
   public function testdriveExport(Request $request)
   {
       ...
       $fileName = 'request_a_test_drive_export_' . time() . '.csv';
       ...
       $response = new StreamedResponse(function () {
        ...
        //    ->whereNotNull('cust.bank_id')
           ->where('applications.type', 'request_a_test_drive')
